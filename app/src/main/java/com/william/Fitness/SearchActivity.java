...
public class SearchActivity extends AppCompatActivity {
    ...
    private List<ExerciseSearch> data() {
        ...
        list.add(new ExerciseSearch(R.drawable.king_pigeon_pose, "King pigeon Pose", "Bài tập uốn dẻo", "1:00"));
        list.add(new ExerciseSearch(R.drawable.facing_dog_pose, "Facing Dog Pose", "Bài tập dãn cơ lưng", "1:00"));
        list.add(new ExerciseSearch(R.drawable.cobra_pose, "Cobra Pose", "Bài tập cho cơ lưng", "1:00"));
        list.add(new ExerciseSearch(R.drawable.camel_pose, "Camel Pose", "Bài tập về cơ lưng", "1:00"));
